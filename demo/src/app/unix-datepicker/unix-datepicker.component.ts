  ...
  providers: [
    {
      ...
      useExisting: UnixDatepickerComponent
    },
  ],
})
export class UnixDatepickerComponent implements ControlValueAccessor, MatFormFieldControl<Date>, OnDestroy, OnInit {
  ...
  static nextId = 0;
  readonly id = `unix-datepicker-${UnixDatepickerComponent.nextId++}`;
